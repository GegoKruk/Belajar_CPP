...
void bangunDatar(){
    ...
    switch (pilihanBangunDatar){
            case 1:
                ...
                cout << "Luas Persegi        : " << ls << endl;
            break;
            case 2:
                cout << "Menghitung Luas Persegi Panjang" << endl;
                cout << "Masukkan nilai sisi panjang (p) : ";
                cin >> p;
                cout << "Masukkan nilai sisi lebar (l)   : ";
                cin >> l;
                ls = p * l;
            ...
            case 3:
                ...
                cout << "Masukkan nilai sisi alas (a)   : ";
                cin >> a;
                cout << "Masukkan nilai sisi tinggi (t) : ";
                cin >> t;
                ls = a * t / 2;
            ...
            case 5:
                ...
                cin >> t;
                ls = p * t;
                cout << "Luas Jajar Genjang              : " << ls << endl;
            break;
            case 6:
                cout << "Menghitung Luas Belah Ketupat" << endl;
                cout << "Masukkan nilai diagonal 1 (d1)  : ";
                cin >> d1;
                cout << "Masukkan nilai diagonal 2 (d2)  : ";
                cin >> d2;
                ls = d1 * d2 / 2;
                cout << "Luas Belah Ketupat              : " << ls << endl;
            break;
            case 7:
                ...
                cin >> d2;
                ls = d1 * d2 / 2;
                cout << "Luas Layang-Layang              : " << ls << endl;
            break;
            case 8:
                cout << "Menghitung Luas Trapesium" << endl;
                cout << "Masukkan nilai sisi sejajar (a1) : ";
                cin >> a1;
                cout << "Masukkan nilai sisi sejajar (a2) : ";
                cin >> a2;
...
void bangunRuang(){
    ...
    switch (pilihanBangunRuang){
            ...
            case 6:
                ...
                cout << "Masukkan nilai alas segitiga (a)   : ";
                cin >> a;
                cout << "Masukkan nilai tinggi segitiga (t) : ";
                cin >> t;
                cout << "Masukkan nilai tinggi limas (t1)   : ";
                cin >> t1;
                v =(a * t / 2) * t1 / 3;
            ...
            case 7:
                ...
                cout << "Masukkan nilai panjang alas (p)  : ";
                cin >> p;
                cout << "Masukkan nilai lebar alas (l)    : ";
                cin >> l;
                cout << "Masukkan nilai tinggi limas (t)  : ";
                cin >> t;
                v = p * l * t / 3;
            ...
            case 8:
                ...
                cout << "Masukkan nilai tinggi segitiga (t) : ";
                cin >> t;
                cout << "Masukkan nilai tinggi prisma (t1)  : ";
                cin >> t1;
                v = a * t / 2 * t1;
...
void menuUtama(){
    ...
    // Tampilan Menu Utama
    cout << "\nProgram Penghitung Luas Bangun Datar atau Volume Bangun Ruang" << endl;
