        ...
        switch (pilihanMainMenu){
            ...
            case 3:
                ...
                if (totalHarga == 0 || totalHarga <=0) {
                    ...
                    //Display Diskon
                    if (totalHarga > 10000 && !sudahPakaiPromo){ //REVISI
                        cout << endl;
                        ...
                        if (pilihanKodePromo == 'Y' || pilihanKodePromo == 'y'){
                            ...
                            while (!selesaiPromo){
                                ...
                                if (kodePromoInput == kodePromoValid){
                                    ...
                                    totalHarga -= diskon;
                                    sudahPakaiPromo = true; //REVISI
                                    cout << "Total Harga Setelah Diskon : Rp" << totalHarga << endl;
                                    selesaiPromo = true;

                                } else {
                                    cout << "Kode promo tidak valid!" << endl;
                                    cout << "1. Coba Lagi" << endl;
                                    cout << "2. Lanjut tanpa promo" << endl; 
                                    cout << "Pilih :" << endl;
                                    cin >> pilihanKodePromoTidakValid;

                                    if (pilihanKodePromoTidakValid == 1){
                                        continue; //ulangi
                                    } else if (pilihanKodePromoTidakValid == 2){
                                        selesaiPromo = true;   // keluar loop 
                                    } else {
                                        system("CLS");     
                                        break; //keluar loop
                                    }
                            ...
                            if (pilihanKodePromoTidakValid == 3 && kodePromoInput != kodePromoValid){
                                continue; //kembali
                            }
                        }
                    }
